...
import schoolLogo from '@assets/IMG_20260825_093502_(1)_1787630760087.jpg';
        ...
        <div className="grid gap-12 lg:grid-cols-[1.3fr_.7fr_.8fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a href="https://instagram.com" aria-label="Instagram" className="grid size-9 place-items-center rounded-full border border-white/15 text-[#e3b45b] hover:bg-white/10" data-testid="link-instagram"><Instagram size={16} /></a>
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-6 text-[#f8eedc]/65">Lewa Educational Union Campus,<br />Jalgaon, Maharashtra 425001</p>
            <p className="mt-4 text-sm text-[#f8eedc]/65">Office hours: Mon–Sat, 9:00 am–3:30 pm</p>
          </div>
        </div>
    ...
    <section className="relative overflow-hidden bg-[#202337] px-5 py-20 text-[#f8eedc] md:py-28">
      ...
      <div className="page-wrap relative grid gap-8 md:grid-cols-[1fr_.65fr] md:items-end">
        <div className="reveal">
          ...
          <h1 className="mt-5 max-w-3xl font-display text-6xl font-bold leading-[.88] tracking-[-.045em] md:text-8xl">{title}</h1>
        </div>
...
function SectionHeading({ eyebrow, title, copy, light = false }: { eyebrow: string; title: string; copy?: string; light?: boolean }) {
  return (
    <div className={`max-w-2xl ${light ? 'text-[#f8eedc]' : 'text-[#202337]'}`}>
      ...
      <h2 className="mt-4 font-display text-5xl font-bold leading-[.94] tracking-[-.04em] md:text-6xl">{title}</h2>
    ...
    <>
      <section className="relative overflow-hidden bg-[#f4e6c9] px-5 pb-20 pt-16 md:pb-28 md:pt-24">
        ...
        <div className="page-wrap grid gap-14 lg:grid-cols-[.95fr_1.05fr] lg:items-center">
          <div className="relative z-10 reveal">
            ...
            <h1 className="max-w-3xl font-display text-[4.7rem] font-bold leading-[.82] tracking-[-.06em] text-[#202337] md:text-[7.4rem]">Where bright<br /><span className="text-[#c94b35]">beginnings</span><br />take root.</h1>
          ...
          <div className="relative min-h-[440px] reveal reveal-2 md:min-h-[540px]">
            <div className="absolute right-[4%] top-0 h-[78%] w-[84%] overflow-hidden rounded-[2.4rem] rounded-bl-[7rem] bg-[#3b7f7c] shadow-2xl shadow-[#202337]/15">
              <img src="/campus-courtyard.jpg" alt="Children arriving at the Saraswati School courtyard" className="size-full object-cover mix-blend-multiply opacity-70" />
              <div className="absolute inset-0 bg-gradient-to-tr from-[#202337]/35 via-transparent to-[#e3b45b]/20" />
              <div className="absolute bottom-7 left-7 text-[#f8eedc]"><p className="font-mono-school text-[9px] uppercase tracking-[.17em]">Jalgaon, Maharashtra</p><p className="mt-1 font-display text-3xl font-bold">A school with a pulse.</p></div>
            </div>
            <div className="float-mark absolute bottom-2 left-0 z-10 w-52 rounded-[1.7rem] bg-[#f8eedc] p-3 shadow-xl md:w-60">
              <img src={schoolLogo} alt="Saraswati Primary English Medium School logo" className="aspect-square w-full rounded-[1.2rem] object-cover" />
              <div className="flex items-center justify-between px-1 pb-1 pt-3"><span className="font-mono-school text-[9px] font-bold uppercase tracking-[.12em] text-[#202337]/55">Our identity</span><Sparkles size={14} className="text-[#c94b35]" /></div>
            </div>
      ...
      <section className="bg-[#f8eedc] px-5 py-20 md:py-28">
        <div className="page-wrap grid gap-14 lg:grid-cols-[.85fr_1.15fr]">
          <SectionHeading eyebrow="The Saraswati way" title="A little more wonder in every school day." copy="We are a State Board school under the Lewa Educational Union, built around the belief that confident learners grow from small moments of care, discovery and belonging." />
      ...
      <section className="bg-[#202337] px-5 py-20 text-[#f8eedc] md:py-28">
        <div className="page-wrap">
          ...
          <Link href="/gallery" className="mt-10 inline-flex items-center gap-2 font-mono-school text-[10px] font-bold uppercase tracking-[.16em] text-[#e3b45b] hover:text-[#f8eedc]" data-testid="link-home-gallery">Walk through our spaces <ArrowRight size={15} /></Link>
        </div>
      </section>
...
function Admissions() {
  ...
  const [form, setForm] = useState({ parent: '', email: '', phone: '', className: '', message: '' });
  ...
  return <>
    ...
    <section className="bg-[#3b7f7c] px-5 py-20 text-[#f8eedc] md:py-28"><div className="page-wrap grid gap-14 lg:grid-cols-[.72fr_1.28fr]"><div><p className="font-mono-school text-[10px] uppercase tracking-[.18em] text-[#e3b45b]">Your first step</p><h2 className="mt-4 font-display text-5xl font-bold leading-[.9] md:text-7xl">Tell us a little<br />about your family.</h2><p className="mt-6 max-w-sm text-sm leading-6 text-[#f8eedc]/65">Share your details and our office will be in touch during meeting hours. This is a friendly enquiry, not a commitment.</p></div><div className="rounded-[2rem] bg-[#f8eedc] p-6 text-[#202337] md:p-9">{submitted ? <div className="flex min-h-[410px] flex-col items-center justify-center text-center"><div className="grid size-16 place-items-center rounded-full bg-[#3b7f7c] text-[#f8eedc]"><Check size={30} /></div><h2 className="mt-6 font-display text-5xl font-bold">Thank you.</h2><p className="mt-4 max-w-sm text-sm leading-6 text-[#202337]/60">Your enquiry is with our team. We’ll call you during office hours to arrange a warm welcome.</p><button type="button" onClick={() => { setSubmitted(false); setForm({ parent: '', email: '', phone: '', className: '', message: '' }); }} className="mt-7 font-mono-school text-[10px] font-bold uppercase tracking-[.16em] text-[#c94b35] underline underline-offset-4" data-testid="button-submit-another">Send another enquiry</button></div> : <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="grid gap-5"><div className="grid gap-5 sm:grid-cols-2"><label className="grid gap-2 text-xs font-bold">Parent / guardian name<input required value={form.parent} onChange={update('parent')} placeholder="Your full name" className="school-input" data-testid="input-parent-name" /></label><label className="grid gap-2 text-xs font-bold">Email address<input required type="email" value={form.email} onChange={update('email')} placeholder="you@example.com" className="school-input" data-testid="input-email" /></label></div><div className="grid gap-5 sm:grid-cols-2"><label className="grid gap-2 text-xs font-bold">Phone number<input required type="tel" value={form.phone} onChange={update('phone')} placeholder="+91 00000 00000" className="school-input" data-testid="input-phone" /></label><label className="grid gap-2 text-xs font-bold">Class applying for<select required value={form.className} onChange={update('className')} className="school-input" data-testid="select-class"><option value="">Choose a class</option><option>Pre-Primary</option><option>Class 1–4</option><option>Class 5–10</option></select></label></div><label className="grid gap-2 text-xs font-bold">What would you like to know?<textarea value={form.message} onChange={update('message')} rows={4} placeholder="Tell us how we can help..." className="school-input resize-none" data-testid="textarea-message" /></label><button type="submit" className="inline-flex w-fit items-center gap-2 rounded-full bg-[#d95340] px-5 py-3.5 text-sm font-extrabold text-[#fff8ee] transition-transform hover:-translate-y-0.5" data-testid="button-submit-enquiry">Send enquiry <Send size={15} /></button><p className="text-[11px] text-[#202337]/45">We respect your privacy and only use these details to respond to your enquiry.</p></form>}</div></div></section>
  </>;
}
...
const galleryItems = [
  { src: '/campus-courtyard.jpg', title: 'A bright place to begin', label: 'Campus life', text: 'Mornings start with a greeting, a deep breath and plenty of room to run.' },
  { src: '/science-lab.jpg', title: 'Questions welcome here', label: 'Science Lab', text: 'Hands-on learning makes the invisible a little easier to see.' },
  { src: '/arts-room.jpg', title: 'Find your rhythm', label: 'Music & Dance', text: 'Our creative rooms make space for expression, practice and applause.' },
];
...
function Gallery() {
  ...
  return <>
    ...
    <section className="bg-[#f4e6c9] px-5 py-16 md:py-24"><div className="page-wrap"><div className="relative overflow-hidden rounded-[2rem] bg-[#202337]"><div className="grid min-h-[500px] md:grid-cols-[1.35fr_.65fr]"><div className="relative min-h-[330px]"><img src={item.src} alt={item.title} className="absolute inset-0 size-full object-cover opacity-85" /><div className="absolute inset-0 bg-gradient-to-r from-[#202337]/35 to-transparent" /><div className="absolute bottom-6 left-6 flex items-center gap-2 rounded-full bg-[#f8eedc]/90 px-3 py-2 font-mono-school text-[9px] font-bold uppercase tracking-[.14em] text-[#202337] md:left-8"><span className="size-1.5 rounded-full bg-[#d95340]" /> {item.label}</div></div><div className="flex flex-col justify-between p-7 text-[#f8eedc] md:p-10"><div><span className="font-mono-school text-[10px] text-[#e3b45b]">{String(active + 1).padStart(2, '0')} / 03</span><h2 className="mt-7 font-display text-5xl font-bold leading-[.88] md:text-6xl">{item.title}</h2><p className="mt-6 text-sm leading-6 text-[#f8eedc]/60">{item.text}</p></div><div className="mt-12 flex items-center justify-between"><div className="flex gap-2">{galleryItems.map((gallery, index) => <button type="button" key={gallery.title} onClick={() => setActive(index)} className={`h-1 rounded-full transition-all ${index === active ? 'w-10 bg-[#e3b45b]' : 'w-5 bg-[#f8eedc]/25'}`} aria-label={`Show ${gallery.title}`} data-testid={`button-gallery-dot-${index}`} />)}</div><div className="flex gap-2"><button type="button" onClick={() => move(-1)} className="grid size-11 place-items-center rounded-full border border-[#f8eedc]/20 hover:bg-[#f8eedc]/10" aria-label="Previous gallery image" data-testid="button-gallery-previous"><ChevronLeft size={18} /></button><button type="button" onClick={() => move(1)} className="grid size-11 place-items-center rounded-full bg-[#e3b45b] text-[#202337] hover:bg-[#f4c979]" aria-label="Next gallery image" data-testid="button-gallery-next"><ChevronRight size={18} /></button></div></div></div></div></div><div className="mt-14 grid gap-5 md:grid-cols-3">{galleryItems.map((gallery, index) => <button type="button" onClick={() => setActive(index)} key={gallery.title} className={`group text-left ${index === active ? 'opacity-100' : 'opacity-60 hover:opacity-100'}`} data-testid={`button-gallery-card-${index}`}><div className="aspect-[1.35] overflow-hidden rounded-2xl bg-[#3b7f7c]"><img src={gallery.src} alt="" className="size-full object-cover transition-transform duration-500 group-hover:scale-105" /></div><p className="mt-4 font-mono-school text-[10px] font-bold uppercase tracking-[.14em] text-[#c77a22]">{gallery.label}</p><p className="mt-2 font-display text-2xl font-bold text-[#202337]">{gallery.title}</p></button>)}</div></div></section>
  </>;
}
...
function Contact() {
  ...
  return <>
    ...
    <section className="bg-[#f8eedc] px-5 py-20 md:py-28"><div className="page-wrap grid gap-14 lg:grid-cols-[.72fr_1.28fr]"><div><SectionHeading eyebrow="The school office" title="We are easy to find." copy="Reach out in the way that suits your family. We will get back to you during meeting hours." /><div className="mt-10 grid gap-5"><ContactLine icon={<MapPin />} label="Address" content={<>P-52, Ajintha Road,<br />Near Lokmat Office, M.I.D.C. Area, Jalgaon.</>} /><ContactLine icon={<Phone />} label="Phone" content={<a href="tel:+912572211814" className="hover:text-[#c94b35]" data-testid="link-contact-phone">0257-2211814</a>} /><ContactLine icon={<Mail />} label="Email" content={<a href="mailto:lewaedusaraswati@gmail.com" className="hover:text-[#c94b35]" data-testid="link-contact-email">lewaedusaraswati@gmail.com</a>} /><ContactLine icon={<Clock3 />} label="Meeting hours" content={<>Principal: 10:00 AM–11:00 AM<br />Working days or by appointment</>} /></div></div><div><div className={`relative min-h-[440px] overflow-hidden rounded-[2rem] bg-[#d9c59b] ${mapOpen ? 'ring-4 ring-[#e3b45b]' : ''}`}><div className="absolute inset-0 opacity-40" style={{ backgroundImage: 'linear-gradient(30deg, #3b7f7c 12%, transparent 12.5%, transparent 87%, #3b7f7c 87.5%, #3b7f7c), linear-gradient(150deg, #3b7f7c 12%, transparent 12.5%, transparent 87%, #3b7f7c 87.5%, #3b7f7c), linear-gradient(30deg, #3b7f7c 12%, transparent 12.5%, transparent 87%, #3b7f7c 87.5%, #3b7f7c), linear-gradient(150deg, #3b7f7c 12%, transparent 12.5%, transparent 87%, #3b7f7c 87.5%, #3b7f7c)', backgroundPosition: '0 0, 0 0, 20px 35px, 20px 35px', backgroundSize: '40px 70px' }} /><div className="absolute inset-0 bg-[#f4e6c9]/40" /><div className="absolute left-[58%] top-[37%] grid size-24 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border-2 border-[#fff8ee]/80 bg-[#d95340] text-[#fff8ee] shadow-xl"><MapPin size={29} fill="currentColor" /></div><div className="absolute bottom-0 left-0 right-0 flex flex-col justify-between gap-4 bg-[#202337]/95 p-6 text-[#f8eedc] sm:flex-row sm:items-end"><div><p className="font-mono-school text-[9px] uppercase tracking-[.14em] text-[#e3b45b]">Map placeholder</p><p className="mt-2 font-display text-2xl font-bold">Saraswati Primary English Medium School</p><p className="mt-1 text-xs text-[#f8eedc]/55">P-52, Ajintha Road · Jalgaon</p></div><button type="button" onClick={() => setMapOpen(!mapOpen)} className="inline-flex items-center gap-2 rounded-full border border-[#f8eedc]/20 px-4 py-2 text-xs font-bold hover:bg-white/10" data-testid="button-map-toggle">{mapOpen ? 'Close preview' : 'Open preview'} <ChevronDown size={14} className={mapOpen ? 'rotate-180' : ''} /></button></div></div><p className="mt-4 text-xs leading-5 text-[#202337]/50">This map preview is a visual guide. Call the office for the best route from your neighbourhood.</p></div></div></section>
    <section className="bg-[#e3b45b] px-5 py-16"><div className="page-wrap flex flex-col justify-between gap-7 md:flex-row md:items-center"><div><p className="font-mono-school text-[10px] uppercase tracking-[.16em] text-[#202337]/60">Stay in the loop</p><h2 className="mt-3 font-display text-4xl font-bold text-[#202337]">Follow our school days.</h2></div><div className="flex gap-3"><a href="https://instagram.com" className="inline-flex items-center gap-2 rounded-full bg-[#202337] px-5 py-3 text-sm font-bold text-[#f8eedc]" data-testid="link-contact-instagram"><Instagram size={16} /> Instagram</a><Link href="/admissions" className="inline-flex items-center gap-2 rounded-full border border-[#202337]/25 px-5 py-3 text-sm font-bold text-[#202337]" data-testid="link-contact-admissions">Enquire now <ArrowRight size={15} /></Link></div></div></section>
  </>;
}
